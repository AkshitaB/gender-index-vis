function HeatMap(svg_elem, full_data){
    ...
    this.render_heat_map = function(domain, sub_domains, records) {
        ...
        var width = curr_obj.width-400, height = curr_obj.height-20;
    ...
    svg.append("g")
      ...
      var legendWidth = 20, legendHeight = height/2;
      ...
      legendsvg.append("g")
          ...
          .attr("transform", "translate(" + (width+60+legendWidth) + "," + (height-legendHeight-height/4) + ")")
          .call(yAxisLegend);
